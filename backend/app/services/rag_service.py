...
def get_rag_service(db: AsyncSession, workspace_id: int) -> "RAGService | NexusRAGService | LegalRAGService":
    """Factory function: route runtime traffic to the active domain service."""
    from app.core.config import settings

    if settings.APP_DOMAIN == "legal" and settings.LEGAL_ENABLED:
