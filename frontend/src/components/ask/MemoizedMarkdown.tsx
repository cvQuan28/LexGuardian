...
// ---------------------------------------------------------------------------
// StreamingMarkdown — used internally
// ---------------------------------------------------------------------------
...
export interface StreamingMarkdownProps {
  ...
  isStreaming?: boolean;
  /** Render function for a single markdown block */
...
export function StreamingMarkdown({
  ...
  return (
    <>
      ...
      {/* In-progress block — re-renders on each token */}
...
// ---------------------------------------------------------------------------
// MemoizedMarkdown — simple export used by StreamingAnswer
// ---------------------------------------------------------------------------
...
export function MemoizedMarkdown({ content, isStreaming = false }: MemoizedMarkdownProps) {
