...
export interface LegalSourcePreview {
  id: number;
  title: string;
...
export type ChatAssistantMode = "document_qa" | "legal_consultation";
...
// LexGuardian-specific additions
export type IntentType = "ASK_DOCUMENT" | "ASK_LAW" | "ANALYZE_RISK" | "CHECK_VALIDITY" | "GENERAL";
